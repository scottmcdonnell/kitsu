export default {
  ...
  'news-stats': {
    ...
    explanation_assignee: 'The 1 or more assignees at the time of the status change. The full quota is given to ALL the assignees.',
    explanation_assignee_split: 'The 1 or more assignees at the time of the status change. The quota is split equally between the number of assignees.',
