export default {
  ...
  'news-stats': {
    ...
    frames: 'Frames',
    highlight_stats: 'Highlight stats below:',
    stat_low_tooltip: 'Highlight where any status has an Initial Status value less than {maxStat}.',
    month: 'Month',
    no_stats: 'There are no stats for these filters.',
    no_news: 'There are no items for these filters.',
    no_data: "No data.",
    name: 'Name',
    person: 'Person',
    assignee_shared: 'Assignee',
    assignee_split: 'Assignee (split)',
    user_mode: 'User mode',
    stats: 'Stats',
    stats_day: 'Stats per day',
    stats_week: 'Stats per week',
    stats_month: 'Stats per month',
    initial: 'Initial',
    repeat: 'Repeat',
    ...
    // initial_status_count: 'First Takes',
    // retake_count: 'Retakes',
    // avg_initial_status: 'Avg First Takes',
    // avg_retake: 'Avg Retakes',
    number_tooltip: 'The 6 month average based on {totalInitial} {unitName} from {fromDate} to {toDate} ({weekCount} weeks)',
    trend_up: 'Trend is up: Recent {recentWeeks} weeks average {recentAvg} {unitName}/week vs older {olderWeeks} weeks average {olderAvg} {unitName}/week',
    trend_down: 'Trend is down: Recent {recentWeeks} weeks average {recentAvg} {unitName}/week vs older {olderWeeks} weeks average {olderAvg} {unitName}/week',
 
    // charts
    charts_title: 'Performance Charts',
    no_chart_data: 'No chart data available for the selected period',
    total_work: 'Total Work',
    total_work_tooltip: 'Total work by {who} for {statusCount} statuses during the selected time range',
    initial_status_rate: 'Initial Status Rate',
    initial_status_rate_tooltip: 'Efficiency: Percentage of task status changes that are initial status changes representing new work',
    day_average: 'Daily Average',
    day_average_tooltip: 'Productivity: average new task status changes per day',
    week_average: 'Weekly Average',
    week_average_tooltip: 'Productivity: average new task status changes per week',
    month_average: 'Monthly Average',
    month_average_tooltip: 'Productivity: average new task status changes per month',
    initial_status_count: 'Initial Status',
    repeat_count: 'Repeat Count',
    avg_initial_status: 'Avg Initial Status',
    avg_repeat: 'Avg Repeat',
    initial_status_timeline: 'Initial Status Count Over Time',
    work_comparison: 'Initial Status vs Repeat Status Comparison',
    performance_trend: 'Performance Trend (Rolling Average)',
    top_performers: 'Top Performers',


    individual_performance_lines: 'Individual Performance Lines (Person + Status)',
  ...
  people: {
    ...
    summary: 'Summary',
    no_status_stats: 'No status statistics available',
    team: 'Team',
    title: 'People',
    unactive: 'Inactive',
    ...
    initial_status_weekly: 'First Take Count per Week',
  ...
  tasks: {
    ...
    status_breakdown: 'Task Status Breakdown',
